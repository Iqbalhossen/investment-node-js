const DirectSells = require('../../models/CoinMiningDirectSellsModel');
const Generation = require('../../models/CoinMiningGenerationModel');
const RoiMint = require('../../models/CoinMinigRoiMintModel');
const TeamSells = require('../../models/CoinMinigTeamSellsModel');

const RoiMintModel = require('../../models/CoinMinigRoiMintModel');
...
const  RoiMint =async(commision,user_name) => {
    ...
    try {
            ...
            if (exsitfirst !== null) {
                ...
                const first = { user_name: exsitfirst.user_name, generation_user_name: user_name, commision: amount,  created_at: pending };
                ...
                if (existsecound !== null) {
                    ...
                    const secound = { user_name: existsecound.user_name, generation_user_name: user_name, commision: amount2,  created_at: pending };
                    ...
                    if (existthird !== null) {
                        ...
                        const thrid = { user_name: existthird.user_name, generation_user_name: user_name, commision: amount3, created_at: pending };
                    ...
                    if (existthirdDeposit !== null) {
                        ...
                        if (existfour !== null) {
                            ...
                            const four = { user_name: existfour.user_name, generation_user_name: user_name, commision: amount4,  created_at: pending };
                            ...
                            if (existfive !== null) {
                                ...
                                const five = { user_name: existfive.user_name, generation_user_name: user_name, commision: amount5, created_at: pending };
